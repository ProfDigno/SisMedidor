...
public class json_config {
    ...
    /**
     * @return the ana_porc_precio_2
     */
    public static int getAna_porc_precio_2() {
        return ana_porc_precio_2;
    }

    /**
     * @param aAna_porc_precio_2 the ana_porc_precio_2 to set
     */
    public static void setAna_porc_precio_2(int aAna_porc_precio_2) {
        ana_porc_precio_2 = aAna_porc_precio_2;
    }

    /**
     * @return the ana_porc_precio_3
     */
    public static int getAna_porc_precio_3() {
        return ana_porc_precio_3;
    }

    /**
     * @param aAna_porc_precio_3 the ana_porc_precio_3 to set
     */
    public static void setAna_porc_precio_3(int aAna_porc_precio_3) {
        ana_porc_precio_3 = aAna_porc_precio_3;
    }
    ...
    private static int ana_porc_precio_2;
    private static int ana_porc_precio_3;
    ...
    public void cargar_jsom_configuracion() {
        ...
        try {
            ...
            String ana_porc_precio_2 = (String) jsonObject.get("ana_porc_precio_2");
            String ana_porc_precio_3 = (String) jsonObject.get("ana_porc_precio_3");
            ...
            setAna_porc_precio_2(Integer.parseInt(ana_porc_precio_2));
            setAna_porc_precio_3(Integer.parseInt(ana_porc_precio_3));
